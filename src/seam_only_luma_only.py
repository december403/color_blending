...
class CBlender():
    ...
    def blend_color(self, refered_pixel_coordi_lst, blending_area_mask, sigma1, sigma2):
        overlap_slic = MaskedSLIC(cv2.cvtColor(self.tar_img, cv2.COLOR_YUV2BGR), blending_area_mask,region_size=20, compactness=5)
...
cv2.imwrite('supa_median_img_gray.png', cv2.cvtColor(a, cv2.COLOR_BGR2GRAY))
